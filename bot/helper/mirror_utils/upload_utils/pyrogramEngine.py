...
class TgUploader:
    ...
    def upload(self, o_files):
        ...
        if self.__total_files <= self.__corrupted:
            self.__listener.onUploadError('Files Corrupted or command message or file was deleted by user. Don't delete commands message or file before completing task. You can check logs!')
            return
